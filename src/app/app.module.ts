...
@NgModule({
  ...
  declarations: [AppComponent, HelloComponent, NewComponent, BenefitNLPSearchSummaryComponent,BenefitNLPSearchDetailsComponent, FilterTagMainComponent, FilterTagDirective, FilterTagComponent],
  providers: [
    HttpClient,
    ApiService,
    {
